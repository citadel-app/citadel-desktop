...
|:---------|:-------------|:---------|-----:|
| 🪟 **Windows** | ARM64 | [citadel-1.2.1-arm64-portable.exe](https://github.com/citadel-app/citadel-desktop/releases/download/v1.2.1/citadel-1.2.1-arm64-portable.exe) | 116 MB |
| 🪟 **Windows** | x64 | [citadel-1.2.1-portable.exe](https://github.com/citadel-app/citadel-desktop/releases/download/v1.2.1/citadel-1.2.1-portable.exe) | 227 MB |
| 🪟 **Windows** | x64 | [citadel-1.2.1-x64-portable.exe](https://github.com/citadel-app/citadel-desktop/releases/download/v1.2.1/citadel-1.2.1-x64-portable.exe) | 110 MB |
